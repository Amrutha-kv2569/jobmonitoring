# -*- coding: utf-8 -*-
"""categorize job .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xY3qZ1C_I2d2YqXwJhYGHyXbJiPjOAoA
"""
...
print(f"Silhouette Score for {len(set(labels))} clusters: {score:.3f}")

from sklearn.metrics import davies_bouldin_score

# Calculate and print the Davies-Bouldin score
db_score = davies_bouldin_score(skill_matrix.toarray(), labels)
print(f"Davies-Bouldin Index for {len(set(labels))} clusters: {db_score:.3f}")

from sklearn.metrics import calinski_harabasz_score

# Calculate and print the Calinski-Harabasz score
ch_score = calinski_harabasz_score(skill_matrix.toarray(), labels)
print(f"Calinski-Harabasz Index for {len(set(labels))} clusters: {ch_score:.3f}")